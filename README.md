...
~~~bash
python resnet152_train.py --test_checkpoint ./checkpoints0.pt test
~~~
This command is used to test the model which uses 500 images from the original dataset.

~~~bash
python resnet152_train.py --test_checkpoint ./checkpoints1.pt test
~~~
...
~~~bash
python resnet152_train.py --test_checkpoint ./checkpoints2.pt test
~~~
